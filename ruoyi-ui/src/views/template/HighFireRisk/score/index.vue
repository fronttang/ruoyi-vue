  ...
  <div class="app-container">
    ...
    <el-dialog :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
      <el-upload
        ...
        :action="upload.url + '?delete=' + upload.delete + '&type=' + upload.unitType"
      ...
      >
        ...
        <div class="el-upload__tip text-center" slot="tip">
          <div class="el-upload__tip" slot="tip">
            ...
            <el-select v-model="upload.unitType" placeholder="请选择业主单元类型" filterable>
              <el-option
                v-for="dict in dict.type.high_risk_type"
                :key="dict.label"
                :label="dict.label"
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/template/IntuitiveDetect/high/import/" + parseInt(this.$route.params.templateId)
      },
    };
  },
  created() {
