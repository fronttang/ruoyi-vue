  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['project:Small:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['project:Small:export']"
        >导出</el-button>
      </el-col>
      <el-col :span="1.5" >
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['project:Small:import']"
        >导入</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
            <el-col :span="12">
              <el-form-item label="业主" label-width="110px" prop="contact">
                <el-input v-model="form.contact" placeholder="请输入业主" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
        ...
        <el-row>
            <el-col :span="24">
              <el-form-item label="单位类型" label-width="110px" prop="unitType">
                <el-select v-model="form.unitType" placeholder="请选择单位类型" filterable>
                  <el-option
                    v-for="dict in dict.type.small_unit_type"
                    :key="dict.value"
                    :label="dict.label"
                    :value="dict.value"
                  ></el-option>
...
export default {
  name: "Small",
  dicts: ['detect_content', 'building_nature', 'small_unit_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/project/OwnerUnit/import/" + this.$store.state.settings.projectId + "/2"
      },
    };
  },
  created() {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除三小场所编号为"' + ids + '"的数据项？').then(function() {
